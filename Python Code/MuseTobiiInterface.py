...
@app.route('/start')
def start_timer():
    global alphaReadings
    global betaReadings
    global thetaReadings
    global timeReadings
    global temp
    global result
    temp = True
...
def stop_timer():
    ...
    for res in result:
        for key in res:
            tp = {"Time":key,"Muse":res[key]}
            finalRes.append(tp)
    return {'time': finalRes}
    ...
    #     # The following loop acquires data, computes band powers, and calculates neurofeedback metrics based on those band powers
        while temp:
            ...
            if dt in timeReadings.keys():
                ...
                timeReadings = {dt:{"alpha":[alpha_metric],"beta":[beta_metric],"theta":[theta_metric]}}
